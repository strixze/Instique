...
export default function Register() {
 ...
 <h2 className="text-lg font-semibold text-deep">Create an account</h2>
 ...
 className="w-full px-3 py-2 bg-white border border-border rounded-lg text-deep focus:outline-none focus:ring-2 focus:ring-forest/30"
 >
