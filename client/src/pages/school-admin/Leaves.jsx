...
>>>>>>> ad3272f98243adbe43ffe771357689a90b09f452
 ...
 className="p-2 text-muted hover:text-success rounded-lg hover:bg-success-light transition-colors disabled:opacity-50"
 title="Approve"
 >
 <Check size={16} />
 </button>
 <button onClick={() => setRejectOpen(r)} className="p-2 text-muted hover:text-danger rounded-lg hover:bg-danger-light transition-colors"title="Reject">
 <X size={16} />
 </button>
 </div>
 ) : (
