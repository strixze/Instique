...
export default function TimetableConfig() {
 ...
 <div className="bg-white/90 border border-border rounded-xl p-5 shadow-xl space-y-4">
 <h3 className="text-md font-semibold text-deep flex items-center gap-2 border-b border-border/60 pb-3">
 <Calendar size={18} className="text-forest"/> Working Days
 </h3>
 ...
 ? 'bg-sage border-forest/50 text-forest'
 : 'bg-white/40 border-border text-muted hover:border-border'
 }`}
 >
 {d.label}
 </button>
 ...
 <div className="bg-white/90 border border-border rounded-xl p-5 shadow-xl space-y-4">
 <h3 className="text-md font-semibold text-deep flex items-center gap-2 border-b border-border/60 pb-3">
 <Clock size={18} className="text-forest"/> School Timings & Periods
 </h3>
 ...
 <h3 className="text-md font-semibold text-deep flex items-center gap-2">
 <Coffee size={18} className="text-forest"/> Lunch Breaks
 </h3>
 <button
 type="button"
 onClick={addLunchBreak}
 className="text-xs text-forest hover:text-forest flex items-center gap-1 font-semibold"
 >
 ...
 <p className="text-sm text-muted italic">No lunch breaks configured.</p>
 ) : (
 <div className="space-y-3">
 {lunchBreaks.map((lb, idx) => (
 <div key={idx} className="flex items-end gap-3 bg-white/40 border border-border/40 rounded-lg p-3">
 ...
 className="p-2 bg-red-950/30 text-red-400 hover:text-danger-text border border-red-900/40 rounded-lg mb-1"
 >
 <Trash2 size={15} />
 </button>
 </div>
 ...
 <div className="bg-white/90 border border-border rounded-xl p-5 shadow-xl space-y-4">
 <h3 className="text-md font-semibold text-deep flex items-center gap-2 border-b border-border/60 pb-3">
 <Settings size={18} className="text-forest"/> Period Slots Timing Grid
 </h3>
 <div className="space-y-3 max-h-[380px] overflow-y-auto pr-1">
 {periodTimings.map((pt, idx) => (
 <div key={idx} className="grid grid-cols-12 gap-3 items-center bg-white/30 border border-border/40 rounded-xl p-3">
 <div className="col-span-1 text-center font-bold text-muted">P{pt.periodNo}</div>
 ...
 <div className="flex items-center justify-between border-b border-border/60 pb-3">
 <h3 className="text-md font-semibold text-deep flex items-center gap-2">
 <Bell size={18} className="text-forest"/> Morning Assembly Settings
 </h3>
 ...
 <div>
 <label className="block text-sm font-medium text-secondary mb-2">Assembly Days</label>
 ...
 ? 'bg-sage border-forest/50 text-forest'
 : 'bg-white/40 border-border text-muted'
 }`}
 >
 {d.label}
 </button>
 ...
 <div className="bg-white/90 border border-border rounded-xl p-5 shadow-xl space-y-4">
 <h3 className="text-md font-semibold text-deep flex items-center gap-2 border-b border-border/60 pb-3">
 <Calendar size={18} className="text-forest"/> Fixed Events / Periods (School-wide)
 </h3>
 
 {/* Event list */}
 {fixedEvents.length === 0 ? (
 <p className="text-sm text-muted italic">No fixed events configured.</p>
 ) : (
 <div className="space-y-2">
 {fixedEvents.map((ev, idx) => (
 <div key={idx} className="flex items-center justify-between bg-white/40 border border-border/40 rounded-xl p-3">
 <div>
 <h4 className="font-semibold text-deep">{ev.title}</h4>
 ...
 className="p-1.5 text-muted hover:text-danger hover:bg-danger-light rounded-lg"
 >
 <Trash2 size={16} />
 </button>
 </div>
 ...
 {/* Event form */}
 <div className="bg-white/20 border border-border rounded-xl p-4 mt-4 space-y-3">
 <h4 className="text-sm font-semibold text-secondary">Add New Fixed Event</h4>
