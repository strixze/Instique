      ...
      <Modal isOpen={open} onClose={resetAndClose} title="Create Custom Role" size="lg">
        ...
        <div className="mt-6">
          ...
          <div className="space-y-2 max-h-72 overflow-y-auto pr-2">
            {MODULES.map((module) => (
              <div key={module} className="flex items-center justify-between p-3 bg-gray-700/30 rounded-lg">
                <span className="text-sm text-gray-200 capitalize">{module.replace('_', ' ')}</span>
