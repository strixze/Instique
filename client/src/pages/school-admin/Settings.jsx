...
export default function Settings() {
  ...
  if (loading) {
    return (
      <div className="space-y-6">
        ...
        <div className="h-24 bg-gray-800 border border-gray-700 rounded-xl animate-pulse" />
        <div className="h-24 bg-gray-800 border border-gray-700 rounded-xl animate-pulse" />
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <h2 className="text-lg font-semibold text-gray-100 mb-4">Fee Settings</h2>
      ...
      <Card>
        <h2 className="text-lg font-semibold text-gray-100 mb-4">Academic Settings</h2>
      ...
      <Card>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
          {Object.keys(settings.notificationToggles || {}).map((key) => (
            <label key={key} className="flex items-center gap-2 text-sm text-gray-300 capitalize">
              <input
                type="checkbox"
      ...
      <Card>
        <h2 className="text-lg font-semibold text-gray-100 mb-4">Grading Scale</h2>
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-700">
                <th className="px-3 py-2 text-left text-xs font-medium text-gray-400 uppercase tracking-wider">Grade</th>
                <th className="px-3 py-2 text-left text-xs font-medium text-gray-400 uppercase tracking-wider">Min %</th>
                <th className="px-3 py-2 text-left text-xs font-medium text-gray-400 uppercase tracking-wider">Max %</th>
                <th className="px-3 py-2 text-left text-xs font-medium text-gray-400 uppercase tracking-wider">Points</th>
              </tr>
            </thead>
