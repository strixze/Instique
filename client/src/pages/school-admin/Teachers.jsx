...
export default function Teachers() {
 ...
 label: 'Subjects',
 render: (r) => {
 if (!Array.isArray(r.subjects) || r.subjects.length === 0) return <span className="text-muted">—</span>;
 return (
 ...
 <button
 onClick={() => openEdit(r)}
 className="p-2 text-muted hover:text-forest rounded-lg hover:bg-sage-soft transition-colors"
 title="Edit teacher"
 >
 <Edit2 size={16} />
 </button>
